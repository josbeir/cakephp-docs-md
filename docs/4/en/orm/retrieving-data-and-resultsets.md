...
Optionally you can `get()` an entity using [Custom Find Methods](../orm/tmp.hzMGgcBvhT#custom-find-methods). For
...
your queries up as [Custom Find Methods](../orm/tmp.hzMGgcBvhT#custom-find-methods) instead. Using custom finder
...
a [Map Reduce](../orm/tmp.hzMGgcBvhT#map-reduce) function to modify the results. The map reduce features
...
not supported with dynamic finders. You should use [Custom Find Methods](../orm/tmp.hzMGgcBvhT#custom-find-methods) to
...
[Eager Loading Associations](../orm/tmp.hzMGgcBvhT#eager-loading-associations).
...
[Filtering By Associated Data](../orm/tmp.hzMGgcBvhT#filtering-by-associated-data).
...
[matching()](../orm/tmp.hzMGgcBvhT#filtering-by-associated-data). If you have defined custom
...
[Lazy Load Associations](../orm/entities#lazy-load-associations) and [Loading Additional Associations](../orm/tmp.hzMGgcBvhT#loading-additional-associations)
...
[Custom Find Methods](../orm/tmp.hzMGgcBvhT#custom-find-methods) section:
