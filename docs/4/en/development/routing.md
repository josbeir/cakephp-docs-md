...
- `_full`  If `true` the value of `App.fullBaseUrl` mentioned in
  [general-configuration](configuration.md#general-configuration) will be prepended to generated URLs.
...
<!-- anchor: route-scoped-middleware -->
...
Elements with numeric keys are treated as [passed-arguments](routing.md#passed-arguments).
...
`Router::reverse()` allows you to use the [request-parameters](../controllers/request-response.md#request-parameters) in cases
