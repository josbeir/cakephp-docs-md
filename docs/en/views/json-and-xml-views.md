...
[controller-viewclasses](/en/controllers.md#controller-viewclasses) features and  let you create JSON and XML responses.
...
[file-extensions](/en/development/routing.md#file-extensions). This will allow you to access the `JSON`, `XML` or
...
By default, when not enabling [file-extensions](/en/development/routing.md#file-extensions), the `Accept`
