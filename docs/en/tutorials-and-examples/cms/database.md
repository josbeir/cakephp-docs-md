...
[naming conventions](/en/intro/conventions.md), we can leverage CakePHP more
...
With the database built, we can now build [Models](/en/tutorials-and-examples/cms/articles-model.md).
