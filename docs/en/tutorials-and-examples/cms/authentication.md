...
[cakephp/authentication](https://book.cakephp.org/authentication/)
...
[Installation](/en/installation.md). If you change that user's password,
...
> (See [CakePHP’s defaults on session.cookie_secure](/en/development/sessions.md))
>
...
they created by [applying authorization policies](/en/./authorization.md).
