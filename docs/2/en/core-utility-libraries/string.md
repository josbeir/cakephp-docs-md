---
title: CakeText
keywords: "array php,array name,string options,data options,result string,class string,string data,string class,placeholders,default method,key value,markup,rfc,replacements,convenience,templates"
---
...
#### Static Method `tokenize($data, $separator = ',', $leftBound = '(', $rightBound = ')')`
...
#### Static Method `insert($string, $data, $options = array())`
...
#### Static Method `cleanInsert($string, $options = array())`
...
#### Static Method `wrap($text, $options = array())`
...
#### Method `highlight(string $haystack, string $needle, array $options = array() )`
...
#### Method `stripLinks($text)`

Strips the supplied `$text` of any HTML links.

#### Method `truncate(string $text, int $length=100, array $options)`
...
#### Method `tail(string $text, int $length=100, array $options)`
...
#### Method `excerpt(string $haystack, string $needle, integer $radius=100, string $ellipsis="...")`
...
#### Method `toList(array $list, $and='and')`
