...
#### Static Method `apply($path, $array, $callback, $options = array())`
...
#### Static Method `check($data, $path = null)`
...
#### Static Method `classicExtract($data, $path = null)`
...
#### Static Method `combine($data, $path1 = null, $path2 = null, $groupPath = null)`
...
#### Static Method `contains($val1, $val2 = null)`
...
#### Static Method `countDim ($array = null, $all = false, $count = 0)`
...
#### Static Method `diff($val1, $val2 = null)`
...
#### Static Method `enum($select, $list = null)`
...
#### Static Method `extract($path, $data = null, $options = array())`
...
#### Static Method `flatten($data, $separator = '.')`
...
#### Static Method `format($data, $format, $keys)`
...
#### Static Method `Set::insert ($list, $path, $data = null)`
...
#### Static Method `map($class = 'stdClass', $tmp = 'stdClass')`
...
#### Static Method `matches($conditions, $data = array(), $i = null, $length = null)`
...
#### Static Method `merge($arr1, $arr2 = null)`
...
#### Static Method `nest($data, $options = array())`
...
#### Static Method `normalize($list, $assoc = true, $sep = ',', $trim = true)`
...
#### Static Method `numeric($array=null)`
...
#### Static Method `pushDiff($array1, $array2)`
...
#### Static Method `remove($list, $path = null)`
...
#### Static Method `sort($data, $path, $dir)`
