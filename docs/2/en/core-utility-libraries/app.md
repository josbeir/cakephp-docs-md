...
Make sure you follow the [file-and-classname-conventions](../getting-started/cakephp-conventions.md#file-and-classname-conventions).
...
#### Static Method `uses(string $class, string $package)`
...
#### Static Method `path(string $package, string $plugin = null)`
...
#### Static Method `core(string $package)`
...
#### Static Method `location(string $className)`
...
#### Static Method `build(array $paths = array(), mixed $mode = App::PREPEND)`
...
#### Static Method `objects(string $type, mixed $path = null, boolean $cache = true)`
...
#### Static Method `pluginPath(string $plugin)`
...
#### Static Method `themePath(string $theme)`
...
#### Static Method `import(mixed $type = null, string $name = null, mixed $parent = true, array $search = array(), string $file = null, boolean $return = false)`
...
#### Static Method `load(string $className)`
