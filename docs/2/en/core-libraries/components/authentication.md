...
In addition to the common configuration, Basic authentication supports the
following keys:
...
Much like `Auth->authenticate`, `Auth->authorize`, helps you keep your code
...
> logins. Defaults to <span class="title-ref">/users/login</span>
>
