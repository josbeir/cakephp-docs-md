...
a wildcard (\*) or [Route Elements](../development/routing#route-elements). Using a wildcard tells the router
...
the `{action}` parameter. By using [Route Elements](../development/routing#route-elements), you can create
...
the [Passed Arguments](../development/routing#passed-arguments) array.
...
[fluent setters](../development/routing#route-fluent-methods) to further configure your route.
...
- `prefix` Used for [Prefix Routing](../development/routing#prefix-routing)
- `_ext` Used for [File extentions routing](../development/routing#file-extensions).
...
- `_method` Define the HTTP verb/method to use. Useful when working with
  [Resource Routes](../development/routing#resource-routes).
...
When connecting routes using [Route Elements](../development/routing#route-elements) you may want to have routed
...
compatible with [Prefix Routing](../development/routing#prefix-routing).
...
Elements with numeric keys are treated as [Passed Arguments](../development/routing#passed-arguments).
...
- `_ext` Used for [File Extensions](../development/routing#file-extensions) routing.
- `_base` Set to `false` to remove the base path from the generated URL. If
  your application is not in the root directory, this can be used to generate
  URLs that are 'cake relative'.
