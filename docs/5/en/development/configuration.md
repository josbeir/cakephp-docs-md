...
configuration engines](https://api.cakephp.org/5.x/interface-Cake.Core.Configure.ConfigEngineInterface.md).
The built in configuration engines are:

- [JsonConfig](https://api.cakephp.org/5.x/class-Cake.Core.Configure.Engine.JsonConfig.md)
- [IniConfig](https://api.cakephp.org/5.x/class-Cake.Core.Configure.Engine.IniConfig.md)
- [PhpConfig](https://api.cakephp.org/5.x/class-Cake.Core.Configure.Engine.PhpConfig.md)
