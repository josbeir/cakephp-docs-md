...
[Database Metadata Cache](../orm/tmp.I6Y4oISjWF#database-metadata-cache) section for more information.
...
See the [Database Configuration](../orm/tmp.I6Y4oISjWF#database-configuration) for more information on the configuration
...
datetime  
See [Datetime Type](../orm/tmp.I6Y4oISjWF#datetime-type).
...
enum  
See [Enum Type](../orm/tmp.I6Y4oISjWF#enum-type).
...
[Database Configuration](../orm/tmp.I6Y4oISjWF#database-configuration). You can also enable this feature at runtime:
