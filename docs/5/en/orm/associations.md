...
- **finder**: The finder method to use when loading associated records. See the
  [association-finder](associations.md#association-finder) section for more information.
...
finder](retrieving-data-and-resultsets.md#custom-find-methods) to load, update, or delete associated records.
