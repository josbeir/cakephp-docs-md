...
> [using-sql-functions](query-builder.md#using-sql-functions) section for how to safely include unsafe data
> into function calls.
>
...
If you have configured [read-and-write-connections](database-basics.md#read-and-write-connections) in your application,
...
[execute the desired SQL directly](database-basics.md#running-select-statements).
