...
Before you [save your data](saving-data.md) you
...
<!-- anchor: validating-request-data -->
...
are documented in the [creating-validators](../core-libraries/validation.md#creating-validators) section.
...
<!-- anchor: using-different-validators-per-association -->
...
<!-- anchor: application-rules -->
## Applying Application Rules

While basic data validation is done when [request data is converted into
entities](validation.md#validating-request-data), many applications also have more complex
...
<!-- anchor: creating-a-rules-checker -->
...
Rules, being it [custom callables](validation.md#creating-a-rules-checker), or
[rule objects](validation.md#creating-custom-rule-objects), can either return a boolean, indicating
...
<!-- anchor: creating-custom-rule-objects -->
