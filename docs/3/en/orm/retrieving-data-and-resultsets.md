...
Optionally you can `get()` an entity using [Custom Find Methods](../orm/tmp.EJqQ2hY0An#custom-find-methods). For
...
your queries up as [Custom Find Methods](../orm/tmp.EJqQ2hY0An#custom-find-methods) instead. Using custom finder
...
a [Map Reduce](../orm/tmp.EJqQ2hY0An#map-reduce) function to modify the results. The map reduce features
...
not supported with dynamic finders. You should use [Custom Find Methods](../orm/tmp.EJqQ2hY0An#custom-find-methods) to
...
[Eager Loading Associations](../orm/tmp.EJqQ2hY0An#eager-loading-associations).
...
[Filtering By Associated Data](../orm/tmp.EJqQ2hY0An#filtering-by-associated-data).
...
[matching()](../orm/tmp.EJqQ2hY0An#filtering-by-associated-data). If you have defined custom
...
[Lazy Load Associations](../orm/entities#lazy-load-associations) and [Loading Additional Associations](../orm/tmp.EJqQ2hY0An#loading-additional-associations)
...
[Custom Find Methods](../orm/tmp.EJqQ2hY0An#custom-find-methods) section:
