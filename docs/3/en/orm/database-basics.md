...
your Table's [_initializeSchema() method](#saving-complex-types):
...
[/console-and-shells/schema-cache](console-and-shells/schema-cache.md) chapter for more information.
