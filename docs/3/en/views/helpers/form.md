...
- `$options` - An optional array that can include both
  [Control Specific Options](../../../views/helpers/tmp.8GoeSoDNMw#control-specific-options), and options of the other methods (which
...
Besides the specific [Control Specific Options](../../../views/helpers/tmp.8GoeSoDNMw#control-specific-options),
...
be found in the [Associated Form Inputs](../../../views/helpers/tmp.8GoeSoDNMw#associated-form-inputs) section.
...
- `$options['type']` - A string that specifies the widget type
  ...
  [Automagic Form Elements](../../../views/helpers/tmp.8GoeSoDNMw#automagic-form-elements), you can also create `'file'`,
...
- `$options['label']` - Either a string caption or an array of
  [options for the label](../../../views/helpers/tmp.8GoeSoDNMw#create-label). You can set this key to the
...
- `$options['options']` - You can provide in here an array containing
  ...
  [Create Radio Button](../../../views/helpers/tmp.8GoeSoDNMw#create-radio-button) and [Create Select Picker](../../../views/helpers/tmp.8GoeSoDNMw#create-select-picker) for more details).
  Defaults to `null`.
...
- `$options['nestedInput']` - Used with checkboxes and radio buttons.
  ...
  [radioWrapper](../../../views/helpers/tmp.8GoeSoDNMw#create-radio-button) template. Depending on the generated
...
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options) as well as any valid HTML attributes.
...
- `$fieldName` - A field name in the form `'Modelname.fieldname'`.
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), of the specific textarea options (see below)
...
In addition to the [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), `textarea()` supports a
...
- `$fieldName` - A field name in the form `'Modelname.fieldname'`.
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), or of the [Checkbox Radio Select Options](../../../views/helpers/tmp.8GoeSoDNMw#checkbox-radio-select-options)
...
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), or specific datetime options (see above),
  as well as any valid HTML attributes.
...
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), of the [Datetime Options](../../../views/helpers/tmp.8GoeSoDNMw#datetime-options), any applicable
  [Time Options](../../../views/helpers/tmp.8GoeSoDNMw#time-options), as well as any valid HTML attributes.
...
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), of the [Datetime Options](../../../views/helpers/tmp.8GoeSoDNMw#datetime-options), any applicable
  [Date Options](../../../views/helpers/tmp.8GoeSoDNMw#date-options), as well as any valid HTML attributes.
...
> [Internationalization & Localization](../../core-libraries/internationalization-and-localization) features.
...
> inside the respective [validator rules](../../../core-libraries/validation#creating-validators).
...
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), or of the specific submit options (see below)
  as well as any valid HTML attributes.
...
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), or of the specific button options (see below)
  as well as any valid HTML attributes.
...
- `$options` - An optional array including any of the
  [General Control Options](../../../views/helpers/tmp.8GoeSoDNMw#general-control-options), or of the specific options (see below) as well
...
new form is being set to a [view block](../../../views#view-blocks) that can be
...
> `block` option to buffer the form into a [view block](../../../views#view-blocks)
...
For more information on string templates, see [Customizing Templates](../../../views/helpers/tmp.8GoeSoDNMw#customizing-templates).
